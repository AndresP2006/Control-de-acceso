        ...
        <div class="block">
            <div class="container">
                ...
                <div class="form-wrapper">
                    ...
                    <form class="dataForm" action="<?php RUTA_URL;?>/UserController/DeleteTorre" method="POST">
        ...
        <div class="block">
            <div class="container">
                ...
                <div class="form-wrapper">
                    ...
                    <form class="dataForm" action="<?php RUTA_URL;?>/UserController/DeleteApartamento" method="POST">
                        <div class="form-group">
